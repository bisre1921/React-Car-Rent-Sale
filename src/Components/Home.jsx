      ...
      <div>
         <div 
          ...
          >   
            ...
            <div className="absolute top-[150px] left-[50px] 2xl:top-[150px] 2xl:left-[190px] bg-transparent mt-20 text-white">
              <div className="">
                <h1 className="text-6xl font-bold mb-4">
                  Unlock Your <span className="text-amber-700">Automotive Destiny</span> 
                </h1>
                <h3 className="text-3xl font-semibold mb-8 2xl:pl-20">
                  Your <span className="text-amber-700">Premier</span>  Destination for Car Sales and Rentals
                </h3>
              </div>
              <p className="tracking-wider font-medium text-xl mb-4 ">
